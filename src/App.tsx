...
function App() {
  ...
  const noFooterPages = ['/billing', '/owner-confirmation', '/quick-confirm', '/sms-confirm', '/confirmation', '/dashboard', '/free-dashboard', '/manage-subscription', '/historique'];
  const shouldShowLayout = !noLayoutPages.includes(location.pathname) && !location.pathname.startsWith('/c/');
  const shouldShowFooter = !noFooterPages.includes(location.pathname) && !location.pathname.startsWith('/c/');
