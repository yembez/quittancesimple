        ...
        <View style={styles.container}>
          <View style={styles.headerTop}>
            <View style={styles.logoSection}>
              <Text style={styles.logoText}>
                <Text style={styles.logoAccent}>Qs</Text> Estate
              </Text>
            </View>
          ...
          <View style={styles.partiesSection}>
            <View style={styles.partiesRow}>
              ...
              <View style={{ width: '75%' }}>
                <Text style={styles.partyValue}>{proprietaire}</Text>
                <Text style={[styles.infoLabel, { marginTop: 2 }]}>{adresseProprietaire}</Text>
          ...
          <View style={styles.signatureSection}>
            <View style={styles.signatureBox}>
              ...
              {data.isElectronicSignature ? (
                <View>
                  <Image
                    src="/tampon_OK-removebg-preview.png"
              ...
              <View style={styles.footerLeft}>
                ...
                {data.isElectronicSignature && (
                  <Text style={styles.footerElectronic}>
                    ✓ Quittance validée électroniquement par le bailleur via Quittance Simple, le {formatDate(currentDate)} à {formatTime(currentDate)}, conformément à l'article 1367 du Code civil sur la valeur juridique de la signature électronique.
                  </Text>
                )}
              </View>
            </View>
