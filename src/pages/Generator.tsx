...
const Generator = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-[#415052]">
                  ...
                  <div className="bg-[#7CAA89]/10 border border-[#7CAA89]/20 rounded-xl p-4">
                    <label className="flex items-start space-x-3 cursor-pointer">
                      <input
                        ...
                        className="w-5 h-5 text-[#2D3436] border-2 border-gray-300 rounded focus:ring-2 focus:ring-[#7CAA89]/20 mt-1"
                      />
                      <div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                    <label className="flex items-start space-x-4 cursor-pointer">
                      <input
                        ...
                        className={`w-5 h-5 text-[#2D3436] border-2 rounded focus:ring-2 mt-1 ${
              ...
              <div className="mt-8 space-y-4">
                ...
                {hasContent() && (
                  <button
                    ...
                    className="w-full bg-[#7CAA89] hover:bg-[#6b9378] text-white px-6 py-3 rounded-xl font-semibold transition-all duration-200 transform hover:-translate-y-1 flex items-center justify-center space-x-2"
                  >
                ...
                <div className="bg-gradient-to-br bg-[#fefdf9] rounded-3xl p-8 border border-gray-200 shadow-xl">
                  <div className="text-center">
                    ...
                    <button
                      ...
                      className="mb-6 inline-flex items-center justify-center bg-[#7CAA89] hover:bg-[#6b9378] text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 transform hover:-translate-y-1 shadow-lg animate-pulse"
                    >
