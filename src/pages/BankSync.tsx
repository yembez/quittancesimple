...
const BankSync = () => {
  ...
  useEffect(() => {
    const initializePage = async () => {
      ...
      if (code) {
        try {
          setConnecting(true);
          console.log('Powens callback détecté');
          ...
          console.log('Appel exchangePublicToken...');
          ...
          setSuccess(`Banque ${result.institution_name} connectée avec succès !`);
          ...
          console.error('Error in Powens callback:', err);
  ...
  const connectBank = async () => {
    try {
      ...
      const tokenResponse = await bankAggregationService.createLinkToken(session.user.id);

      window.location.href = tokenResponse.link_token;
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {success && (
          <div className="mb-6 bg-gray-50 border border-gray-200 rounded-lg p-4 flex items-start">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Connexion via Powens (ex-Budget Insight) - Agrégateur certifié DSP2</li>
            <li>• Vos identifiants bancaires ne transitent jamais par nos serveurs</li>
            <li>• Connexion chiffrée de bout en bout conforme PSD2</li>
            <li>• Vous pouvez révoquer l'accès à tout moment</li>
            <li>• Plus de 300 banques françaises supportées</li>
          </ul>
        </div>
            ...
            <div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <p className="text-sm text-gray-600 mb-6">
                  En un clic, connectez votre banque de manière 100% sécurisée avec Powens, l'agrégateur bancaire français conforme DSP2 utilisé par les plus grandes fintech.
                </p>
                ...
                <div className="mb-4">
                  <button
                    ...
                    disabled={syncing}
                    className="w-full bg-[#2D3436] hover:bg-[#1a1f20] disabled:bg-gray-400 disabled:cursor-not-allowed text-white py-2 px-4 rounded-lg font-semibold transition-all flex items-center justify-center"
                  >
              ...
              <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  <strong>Plus de 300 banques françaises supportées :</strong> BNP Paribas, Crédit Agricole, Société Générale, LCL, Banque Postale, Crédit Mutuel, CIC, Boursorama, N26, Revolut, et toutes les banques en ligne.
                </p>
              </div>
            </div>
          </>
