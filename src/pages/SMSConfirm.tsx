          ...
          <div>
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={loading}
                className="w-full bg-[#2D3436] hover:bg-[#1a1f20] text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
              >
                {loading ? (
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-[#FFD76F] hover:bg-[#d4a03f] text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
              >
