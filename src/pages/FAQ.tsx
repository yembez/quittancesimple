  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24">
      <SEOHead
        ...
        description="Réponses rapides sur la quittance de loyer : conformité, PDF, automatisation, envoi, relance et abonnement Quittance Automatique."
