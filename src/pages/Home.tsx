          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-5 lg:gap-10 items-center">
            ...
            >
              ...
              >
                ...
                <h2 className="text-base sm:text-xl lg:text-2xl text-[#545454] font-medium leading-snug mt-2 hidden sm:block lg:block">
                 Générez votre PDF gratuit conforme en moins de 2 minutes <span className="text-base sm:text-xl lg:text-2xl text-[#ed7862] font-medium leading-snug">ou </span>automatisez vos envois mensuels pour <span className="text-base sm:text-xl lg:text-2xl text-[#ed7862] font-medium leading-snug">0,82€/mois</span><span className="text-base sm:text-xl lg:text-xl text-[#545454] font-medium leading-snug"> (soit 9,90€/an, offre de lancement)</span>.
                </h2>
              </div>
...
>
  ...
  <div className="text-[11px] font-normal opacity-90 mt-0.5">
    En moins de 2 minutes · PDF conforme
                ...
                >
                  <div className="text-[15px] font-bold leading-tight">Découvrir l'automatisation</div>
                  <div className="text-[11px] font-normal opacity-75 mt-0.5">Et ne plus y penser</div>
                </Link>
              </div>
              ...
              <div className="hidden sm:block space-y-6">
                ...
                <div className="space-y-4">
                  <p className="text-base sm:text-lg text-[#545454] leading-relaxed">
                    Avec Quittance Automatique, vous envoyez vos quittances en un clic chaque mois, et vous n'y pensez plus !<br />
              ...
              {/* Visuel homme relaxé - desktop */}
              <div className="mt-6 lg:mt-8 flex justify-start hidden sm:flex">
                <img
                  ...
                  className="w-[180px] sm:w-[220px] lg:w-[250px] h-auto object-contain"
                />
              </div>

            </motion.div>

            {/* Bloc "Quittance Automatique" - MASQUÉ sur mobile */}
            <motion.div
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 sm:p-6 lg:p-8 space-y-5">
                <div className="text-center">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-[#2b2b2b] leading-tight mb-1.5">
                    Envoyez vos quittances en 1 clic <br />avec Quittance Automatique
                  </h3>
                  <div className="space-y-0.5">
                    <p className="text-lg sm:text-xl lg:text-xl text-[#2b2b2b] font-semibold">
                      À partir de 9,90€/an  <span className="text-[25px] sm:text-sm text-[#545454]">
                
                    soit 0,82€/mois (offre de lancement)</span>  <p className="text-lg sm:text-xl lg:text-xl text-[#2b2b2b]">
                ...
                <div className="space-y-3">
                  <Link to="/automation" className="flex gap-2 sm:gap-3 items-center hover:opacity-80 transition-opacity">
                    <div className="flex-shrink-0">
                      <img
                        src="https://jfpbddtdblqakabyjxkq.supabase.co/storage/v1/object/public/website-images/woman_mobile_screen4.png"
                        alt="Quittance de loyer simple - Notification loyer reçu automatique"
                        className="w-[100px] sm:w-[130px] lg:w-[180px] h-auto object-contain"
                      />
                    </div>
                    <div className="space-y-1 flex-1 min-w-0 text-xs sm:text-sm lg:text-base text-[#2b2b2b] font-medium"> Avec
                      ...
                      <p className="text-xs sm:text-sm lg:text-base text-[#2b2b2b] font-medium leading-snug">
                        Rien de plus simple, vous recevez un rappel chaque mois et vous envoyez la quittance en 1 seul clic.
                      </p>
                    </div>
                  </Link>
  {/* Card Locataire <br />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <div className="text-sm text-[#2b2b2b]">
                    <span className="font-semibold">Marre de faire vos quittances manuellement ?</span>
