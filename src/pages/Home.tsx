...
const Home = () => {
  ...
  const [showFreeSignup, setShowFreeSignup] = React.useState(false);
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-[#2b2b2b] pt-16">
      <SEOHead
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <motion.div
              ...
              className="space-y-8 lg:py-8 order-2 lg:order-1"
            >
              <div className="space-y-4">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#2b2b2b] leading-tight">
                  Gérez enfin vos<br />quittances sans effort<br />avec <span className="text-[#2b2b2b] font-bold">l'envoi automatique</span>
                </h1>
                <p className="text-base sm:text-lg text-[#545454] leading-snug">
                  Votre temps est précieux, économisez le en automatisant l'envoi de vos quittances.
                </p>
              </div>

              <div className="flex items-center gap-2 text-sm sm:text-base text-[#545454] mb-4">
                <span>Créé par des propriétaires, pour des propriétaires</span>
                <Heart className="w-4 h-4 sm:w-5 sm:h-5" style={{
              ...
              <div className="flex justify-end">
                <Link
                  to="/automation"
                  className="rounded-full px-8 py-3 bg-[#ed7862] hover:bg-[#e56651] text-white text-base sm:text-lg font-semibold transition-colors shadow-sm flex items-center gap-2"
                >
              ...
              <div className="space-y-4">
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#545454] leading-tight">
                  Besoin d'une quittance ?<br />Créez gratuitement vos quittances PDF
                </h2>
                <p className="text-base sm:text-lg text-[#545454] leading-snug">
                  Remplissez simplement les informations du bailleur et du locataire, et recevez par e-mail une quittance PDF conforme à la loi française.
                </p>
              </div>
              ...
              <div className="flex justify-start">
                <button
                  ...
                  className="rounded-full px-8 py-3 bg-[#415052] text-white text-base sm:text-lg font-semibold hover:bg-[#344042] transition-colors shadow-sm flex items-center gap-2"
                >
            ...
            >
              <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-10 lg:p-12 space-y-8">
                <div className="text-center">
                  <h3 className="text-3xl sm:text-4xl font-bold text-[#2b2b2b] leading-tight mb-2">
                    L'envoi automatique en 2 offres
                  </h3>
                  <p className="text-2xl sm:text-3xl text-[#7CAA89]">
                    à partir de <span className="font-semibold">1€/mois</span>
                  </p>
                </div>

                <div className="space-y-6">
                  <Link to="/automation" className="flex gap-4 sm:gap-6 items-center hover:opacity-80 transition-opacity">
                    ...
                    <div className="space-y-2 flex-1 min-w-0">
                      <h4 className="text-lg sm:text-xl lg:text-3xl font-bold text-[#ed7862] leading-tight">
                        Quittance<br />Automatique
                      </h4>
                      <p className="text-base sm:text-lg lg:text-xl text-[#545454] font-medium leading-snug">
                        Configurez 1 fois, recevez un rappel chaque mois. Vous envoyez la quittance en 1 clic.
                      </p>
                    </div>
                  </Link>

                  <Link to="/automation" className="flex gap-4 sm:gap-6 items-center hover:opacity-80 transition-opacity">
                    <div className="flex-shrink-0 ml-3 sm:ml-5 lg:ml-6">
                      <img
                        src="https://jfpbddtdblqakabyjxkq.supabase.co/storage/v1/object/public/website-images/homme_bras_back_final.png"
                        alt="Homme relaxé"
                        className="w-[150px] sm:w-[200px] lg:w-[280px] h-auto object-contain"
                      />
                    </div>
                    <div className="space-y-2 flex-1 min-w-0">
                      <h4 className="text-lg sm:text-xl lg:text-3xl font-bold text-[#2b2b2b] leading-tight">
                        Quittance<br />Connectée<span className="text-[#A46BFF] text-xl sm:text-2xl lg:text-3xl">+</span>
                      </h4>
                      <p className="text-base sm:text-lg lg:text-xl text-[#545454] font-medium leading-snug">
                        <span className="font-bold text-[#7CAA89]">Synchronisation de votre compte bancaire</span> - Vous n'avez plus rien à faire, tout part automatiquement
                      </p>
                    </div>
                  </Link>
                </div>
      ...
      <section id="generator" className="py-16 sm:py-24 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-xl lg:text-3xl font-bold text-[#2b2b2b] mb-4">
              Générateur gratuit de quittances
            </h2>
            <p className="text-base lg:text-lg text-[#545454] max-w-2xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="bg-white rounded-3xl border border-gray-200 p-8 shadow-xl">
              <form className="space-y-8">
                <div className="space-y-6 bg-[#7CAA89]/10 rounded-2xl p-6 border border-[#7CAA89]/20">
                  <div className="flex items-center space-x-3 pb-4 border-b border-[#7CAA89]/20">
                    <div className="w-12 h-12 bg-[#7CAA89] rounded-xl flex items-center justify-center">
                      <User className="w-6 h-6 text-white" />
                    </div>
                    <h3 className="text-xl font-bold text-[#2b2b2b]">Informations Bailleur</h3>
                  </div>

                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Nom complet</label>
                      <input
                        type="text"
                        name="baillorName"
                        value={formData.baillorName}
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#7CAA89] focus:ring-2 focus:ring-[#7CAA89]/20 transition-all duration-200"
                        placeholder="Ex: Jean Dupont"
                        required
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Adresse complète</label>
                      <input
                        type="text"
                        name="baillorAddress"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Email</label>
                      <input
                        type="email"
                        name="baillorEmail"
                ...
                <div className="space-y-6 bg-[#7CAA89]/10 rounded-2xl p-6 border border-[#7CAA89]/20">
                  <div className="flex items-center space-x-3 pb-4 border-b border-[#7CAA89]/20">
                    ...
                    <h3 className="text-xl font-bold text-[#2b2b2b]">Informations Locataire</h3>
                  </div>

                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Nom du locataire</label>
                      <input
                        type="text"
                        name="locataireName"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Adresse du logement</label>
                      <input
                        type="text"
                ...
                <div className="space-y-6 bg-[#7CAA89]/10 rounded-2xl p-6 border border-[#7CAA89]/20">
                  <div className="flex items-center space-x-3 pb-4 border-b border-[#7CAA89]/20">
                    ...
                    <h3 className="text-xl font-bold text-[#2b2b2b]">Montants</h3>
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Loyer mensuel (€)</label>
                      <input
                        type="number"
                        name="loyer"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Charges mensuelles (€)</label>
                      <input
                        type="number"
                        name="charges"
                  ...
                  {!formData.isProrata && (
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Période</label>
                      <div className="relative">
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 focus:border-[#7CAA89] focus:ring-2 focus:ring-[#7CAA89]/20 transition-all duration-200 appearance-none bg-white"
                        >
                  ...
                  <div className="bg-[#7CAA89]/10 border border-[#7CAA89]/20 rounded-xl p-4">
                    <label className="flex items-start space-x-3 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={formData.isProrata}
                        onChange={(e) => setFormData(prev => ({ ...prev, isProrata: e.target.checked }))}
                        className="w-5 h-5 text-[#7CAA89] border-2 border-gray-300 rounded focus:ring-2 focus:ring-[#7CAA89]/20 mt-1"
                      />
                      <div>
                ...
                {formData.isProrata && (
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Date d'entrée</label>
                      <input
                        type="date"
                        name="dateDebut"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-[#545454] mb-2">Date de sortie</label>
                      <input
                        type="date"
                        name="dateFin"
                ...
                <div className="space-y-6 bg-[#7CAA89]/10 rounded-2xl p-6 border border-[#7CAA89]/20">
                  <div className="flex items-center space-x-3 pb-4 border-b border-[#7CAA89]/20">
                    ...
                    <h3 className="text-xl font-bold text-[#2b2b2b]">Validation</h3>
                  </div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                    <label className="flex items-start space-x-4 cursor-pointer">
                      ...
                      />
                      <div>
                        <div className="text-lg font-bold text-[#2b2b2b] mb-2">
              ...
              <div className="mt-8 space-y-4">
                ...
                {hasContent() && (
                  <button
                    ...
                    className="w-full border-2 border-gray-300 hover:border-[#ed7862] text-[#545454] hover:text-[#ed7862] px-6 py-3 rounded-xl font-semibold transition-all duration-200 transform hover:-translate-y-1 bg-white/80 backdrop-blur-sm flex items-center justify-center space-x-2"
                  >
              ...
              {showPreview && hasAnyContent() ? (
                ...
                <div className="bg-gradient-to-br bg-[#fefdf9] rounded-3xl p-8 border border-gray-200 shadow-xl">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-[#2b2b2b] mb-4">Quittance conforme</h3>
                    ...
                    <button
                      ...
                      className="mb-6 inline-flex items-center justify-center bg-[#ed7862] hover:bg-[#e56651] text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 transform hover:-translate-y-1 shadow-lg"
                    >
      ...
      <FreeSignupModal
        isOpen={showFreeSignup}
        onClose={() => setShowFreeSignup(false)}
        prefillData={{
