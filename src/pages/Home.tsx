            ...
            >
              ...
              >
                ...
                <h2 className="text-[20px] lg:text-0xl text-[#545454] font-medium leading-snug mt-2 hidden sm:block lg:block">
                 Générez votre PDF gratuit conforme en quelques secondes <span className="text-base sm:text-xl lg:text-2xl text-[#ed7862] font-medium leading-snug">ou </span>automatisez vos envois mensuels pour <span className="text-base sm:text-xl lg:text-2xl text-[#ed7862] font-medium leading-snug">0,82€/mois</span><span className="text-[20px] lg:text-0xl text-[#545454] font-medium leading-snug"> (soit 9,90€/an, offre de lancement)</span>.
                </h2>
              </div>
              ...
              <div className="hidden sm:block space-y-6">
                ...
                <div className="space-y-4">
                  <p className="text-base sm:text-lg text-[#545454] leading-relaxed">
                    Avec Quittance Automatique, et nos automatisations on envoie vos quittances (ou vos rappel de loyer), on calcule vos bilans annuels, vos IRL pour vous, et vous n'y pensez plus !<br />
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 sm:p-6 lg:p-8 space-y-5">
                <div className="text-center">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-[#2b2b2b] leading-tight mb-1.5">
                    Automatisez l'envoi et n'y pensez plus <br />avec Quittance Automatique
                  </h3>
                  ...
                  >
                    ...
                    <div className="space-y-1 flex-1 min-w-0 text-xs sm:text-sm lg:text-base text-[#2b2b2b] font-medium"> Avec
                      ...
                      <p className="text-xs sm:text-sm lg:text-sm text-[#2b2b2b] font-medium leading-snug">
                        Rien de plus simple, <strong>on s'occupe de tout! </strong>Vos quittances, vos calculs de bilans annuels, votre calcul IRL etc. On s'en charge mais vous gardez le contrôle.
                      </p>
                    </div>
                  </Link>
  {/* Card Locataire <br />
