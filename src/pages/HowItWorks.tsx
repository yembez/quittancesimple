  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-[#1a1f20] text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            >
              ...
              <div className="inline-block bg-[#2D3436]/20 text-[#1a1f20] px-4 py-1 rounded-full text-sm font-bold mb-4">
                ÉTAPE 1
              </div>
              <h3 className="text-2xl font-bold text-[#1a1f20] mb-4">Remplissez le formulaire</h3>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-[#1a1f20] mb-4">Validez et signez</h3>
              <p className="text-[#415052] leading-relaxed mb-4">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-[#1a1f20] mb-4">Recevez votre PDF</h3>
              <p className="text-[#415052] leading-relaxed mb-4">
      ...
      <section className="py-16 bg-[#fefdf9]">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-[#1a1f20] text-center mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-3xl p-8 shadow-xl">
              ...
              <h3 className="text-3xl font-bold text-[#1a1f20] mb-4">Mode Gratuit</h3>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-[#2D3436] mr-3 flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl relative">
              ...
              <h3 className="text-3xl font-bold text-[#1a1f20] mb-4">Mode Automatique</h3>
              <p className="text-[#415052] mb-6 leading-relaxed">
              ...
              <Link
                to="/automation"
                className="block text-center bg-[#2D3436] text-white px-6 py-3 rounded-full font-bold hover:bg-[#6a9d7f] transition-all"
              >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-[#1a1f20] text-center mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1a1f20] mb-2">Gain de temps</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1a1f20] mb-2">100% Conforme</h3>
              <p className="text-[#415052]">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1a1f20] mb-2">Facile d'utilisation</h3>
              <p className="text-[#415052]">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1a1f20] mb-2">Envoi automatique</h3>
              <p className="text-[#415052]">
      ...
      <section className="py-16 bg-[#2D3436]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/generator"
              className="bg-white text-[#2D3436] px-8 py-4 rounded-full font-bold shadow-lg hover:bg-gray-100 transition-all flex items-center justify-center"
            >
              Essayer gratuitement
              <ArrowRight className="w-5 h-5 ml-2" />
            </Link>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-[#1a1f20] mb-8">Questions fréquentes sur le fonctionnement</h2>
          ...
          <div className="mt-8 text-center">
            <Link
              to="/faq"
              className="text-[#2D3436] font-semibold hover:text-[#6a9d7f] inline-flex items-center"
            >
