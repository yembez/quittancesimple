...
const AutomatisationEnvoi = () => {
  ...
  return (
    <div className="min-h-screen bg-amber-50">
      <SEOHead
        title="Automatisation Envoi Quittances | Envoyer Quittance Automatiquement dès 1€"
        description="Automatisez l'envoi de vos quittances de loyer par email et SMS. Génération automatique, envoi programmé, rappels automatiques. Solution complète dès 1€/mois."
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center bg-white rounded-full px-4 py-2 shadow-sm mb-6">
              ...
              <span className="text-sm font-medium text-gray-700">Automatisation complète · Dès 1€/mois</span>
            </div>

            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Automatisez l'envoi<br />
              <span className="text-orange-600">de vos quittances</span>
            </h1>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Avec la synchronisation bancaire (option Automatique+), le système détecte automatiquement quand un loyer est payé et déclenche l'envoi de la quittance.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-8">
              <h3 className="text-2xl font-bold text-green-900 mb-6">✓ Avec automatisation</h3>
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start">
                  <Zap className="w-5 h-5 text-green-600 mr-3 flex-shrink-0 mt-1" />
          ...
          <div className="space-y-4">
            <details className="bg-white rounded-2xl p-6 shadow-md cursor-pointer">
              ...
              <p className="text-gray-700 mt-4 leading-relaxed">
                Il suffit de vous inscrire au plan Automatique (1€/mois pour le 1er locataire), d'enregistrer les informations de vos locataires, et de configurer la date d'envoi mensuelle. Le système s'occupe du reste automatiquement.
              </p>
            </details>
            ...
            <details className="bg-white rounded-2xl p-6 shadow-md cursor-pointer">
              ...
              <p className="text-gray-700 mt-4 leading-relaxed">
                Avec le plan Automatique, vous validez manuellement chaque paiement en 1 clic. Avec le plan Automatique+ (1,50€/mois), la synchronisation bancaire détecte automatiquement les paiements entrants et déclenche l'envoi sans intervention de votre part.
              </p>
            </details>
            ...
            <details className="bg-white rounded-2xl p-6 shadow-md cursor-pointer">
              ...
              <p className="text-gray-700 mt-4 leading-relaxed">
                Oui ! Le prix est de 1€/mois pour le 1er locataire, puis +0,60€/mois par locataire supplémentaire. Vous pouvez gérer autant de locataires que nécessaire avec l'automatisation.
              </p>
            </details>
          </div>
        </div>
