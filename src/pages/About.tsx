          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center bg-white rounded-full px-4 py-2 shadow-sm mb-6">
                <Heart className="w-4 h-4 mr-2 fill-white text-black stroke-black stroke-2" />
                <span className="text-sm font-medium text-[#415052]">Notre histoire</span>
              </div>

              <h1 className="text-4xl lg:text-5xl font-bold text-[#2b2b2b] mb-6 leading-tight">
                Créé par des propriétaires,<br />
                <span className="text-[#7CAA89]">pour des propriétaires</span>
              </h1>

              <p className="text-base text-[#415052] mb-6 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg mb-8">
                <h3 className="text-2xl font-bold text-[#2b2b2b] mb-4">Notre démarche</h3>
                <p className="text-base text-[#415052] mb-4 leading-relaxed">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-12 h-12 bg-[#7CAA89] rounded-xl flex items-center justify-center mx-auto mb-3 shadow-sm">
                        <IconComponent className="w-6 h-6 text-white" />
                      </div>
                      <div className="text-2xl font-bold text-[#2b2b2b] mb-1">{stat.number}</div>
            ...
            >
              ...
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-[#7CAA89] rounded-2xl flex items-center justify-center shadow-xl">
            ...
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-[#2b2b2b] mb-4">{value.title}</h3>
                  <p className="text-base text-[#415052] leading-relaxed">{value.description}</p>
                </motion.div>
              );
            })}
          </div>
      ...
      <section className="py-12 bg-[#fefdf9]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <Coffee className="w-12 h-12 text-[#7CAA89] mx-auto mb-4" />
              <h3 className="font-bold text-[#2b2b2b] mb-2">Simple et intuitif</h3>
              <p className="text-base text-[#415052]">Une interface pensée pour être comprise en quelques secondes</p>
            </div>
            <div>
              <Users className="w-12 h-12 text-[#7CAA89] mx-auto mb-4" />
              <h3 className="font-bold text-[#2b2b2b] mb-2">Support humain</h3>
              <p className="text-base text-[#415052]">Une vraie équipe qui comprend vos besoins de propriétaire</p>
            </div>
            <div>
              <Heart className="w-12 h-12 mx-auto mb-4 fill-white text-[#7CAA89] stroke-[#7CAA89] stroke-2" />
              <h3 className="font-bold text-[#2b2b2b] mb-2">Tarifs honnêtes</h3>
              <p className="text-base text-[#415052]">Des prix justes, sans surprise ni frais cachés</p>
            </div>
          </div>
        </div>
      </section>

      <section className="py-20 bg-[#7CAA89]">
        <div className="max-w-4xl mx-auto px-6 text-center text-white">
          ...
          <Link
            to="/automation"
            className="inline-flex items-center bg-white text-[#7CAA89] px-10 py-5 rounded-full font-bold text-xl shadow-xl hover:shadow-2xl transition-all"
          >
