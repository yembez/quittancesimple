    ...
    try {
      ...
      const { data: checkoutSession, error: checkoutError } = await supabase.functions.invoke('stripe-checkout', {
        body: {
          ...
          cancel_url: `${window.location.origin}/free-dashboard?canceled=true&email=${encodeURIComponent(proprietaire.email)}`
        }
      });
                    ...
                    <div className="relative group">
                      ...
                      <div className="absolute right-0 top-full mt-2 w-80 bg-gray-900 text-white text-sm rounded-lg p-3 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                        <p className="leading-relaxed">
                          Pour profiter de l'ajout de plusieurs locataires et de l'envoi automatique, essayez <span className="font-semibold">Quittance Automatique</span> dès <span className="font-semibold">0,99€/mois</span> (1,49€/mois pour 3-4 locataires, 2,49€/mois pour 5+)
                        </p>
