  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead
        ...
        description="Automatisez l'envoi de vos quittances de loyer : rappels intelligents SMS/email ou synchronisation bancaire PSD2 avec détection automatique des paiements. Dès 1€/mois TTC."
      ...
      <section className="pt-24 pb-12 bg-[#fefdf9]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl lg:text-5xl font-bold text-[#1a1f20] mb-3">
              Deux niveaux d'automatisation
            </h1>
            <p className="text-base text-[#415052]/70 mb-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="flex items-start justify-center -gap-4 lg:gap-2 mb-8 flex-1">
                ...
                <div className="relative flex-shrink-0 mt-8">
                  {/* Phone frame */}
                  <div className="w-24 lg:w-32 h-[180px] lg:h-[220px] bg-gradient-to-br from-[#2D3436] to-[#3a4447] rounded-[1.5rem] p-2 shadow-2xl relative">
                    {/* Notch */}
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-16 h-4 bg-[#1a1f20] rounded-b-xl"></div>

                    {/* Screen */}
                    <div className="w-full h-full bg-gradient-to-b from-[#4a5052] to-[#3d4447] rounded-[1.2rem] p-2 flex flex-col items-center justify-center relative overflow-hidden">
                      {/* Content */}
                      <div className="text-center space-y-2 z-10">
                        ...
                        {/* Button OUI */}
                        <button className="w-full bg-[#4CAF50] text-white font-semibold py-2 px-2 rounded-lg shadow-lg text-[10px] leading-tight">
              ...
              {/* Phrase descriptive */}
              <p className="text-center text-base text-[#415052] mb-6">
              ...
              <div className="bg-[#fefdf9] rounded-2xl p-6 mb-6">
                <div className="flex items-baseline mb-2">
                  ...
                  <span className="text-[#415052] ml-2">/mois — 1er locataire</span>
                </div>
                <p className="text-2xl text-[#415052] font-semibold">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-[#FFF8E7] to-[#FFFBF0] rounded-3xl p-8 lg:p-10 relative overflow-hidden flex flex-col"
            >
              {/* Titre */}
              <h2 className="text-3xl lg:text-4xl font-bold text-[#2d5052] mb-8">
                Quittance<br />Connectée<span className="text-[#415052]">+</span>
              </h2>
              ...
              <div className="relative flex justify-center flex-1 items-start mt-8 mb-2">
                ...
                <div className="absolute top-0 -right-4 lg:right-8">
                  <div className="bg-gradient-to-br from-[#2D3436] to-[#3a4447] rounded-2xl p-3 shadow-2xl max-w-[140px]">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-[#415052] rounded-full flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
                    <Check className="w-4 h-4 text-white" />
                  </div>
                  <div>
              ...
              {/* Prix */}
              <div className="bg-[#FFF8E7] rounded-2xl p-6 mb-6 border border-[#FFD76F]/20">
                <div className="flex items-baseline mb-2">
              ...
              <button
                ...
                className="w-full py-4 rounded-full bg-[#2D3436] hover:bg-[#1a1f20] text-white font-bold transition-all transform hover:scale-105"
              >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="w-16 h-16 bg-[#ed7862]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Clock className="w-8 h-8 text-[#ed7862]" />
              </div>
              <h3 className="text-xl font-bold text-[#1a1f20] mb-3">
                Gagnez du temps
              </h3>
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl p-8 text-center shadow-sm"
            >
              <div className="w-16 h-16 bg-[#FFF8E7] rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Shield className="w-8 h-8 text-[#415052]" />
              </div>
              <h3 className="text-xl font-bold text-[#1a1f20] mb-3">
                100% conforme
              </h3>
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl p-8 text-center shadow-sm"
            >
              <div className="w-16 h-16 bg-[#415052]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Zap className="w-8 h-8 text-[#415052]" />
              </div>
              <h3 className="text-xl font-bold text-[#1a1f20] mb-3">
                Zéro oubli
              </h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-[#1a1f20] mb-8">
            ...
            <div className="prose prose-lg max-w-none text-[#415052]">
              ...
              <h3 className="text-2xl font-bold text-[#1a1f20] mt-8 mb-4">
              ...
              <h3 className="text-2xl font-bold text-[#1a1f20] mt-8 mb-4">
                Synchronisation bancaire PSD2 sécurisée
              </h3>
              <p className="mb-6 leading-relaxed">
              ...
              <div className="bg-[#FFF8E7] rounded-2xl p-8 border border-[#FFD76F]/20 mt-8">
      ...
      <div className="bg-gray-50 pb-8">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <p className="text-sm text-[#415052]/70">* supplémentaire</p>
        </div>
      </div>
