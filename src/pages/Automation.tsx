        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h1 className="text-2xl sm:text-3xl lg:text-3xl font-bold text-[#1a1f20] mb-4 leading-tight">
              La vraie quittance automatisée... et bien plus.
            </h1>

            <p className="text-base text-[#ed7862] font-bold mb-4 sm:mb-6">
              La gestion locative qui vous évite d’y penser, tout en gardant le contrôle<br />
            ...
            <div className="space-y-2 sm:space-y-4 text-left flex justify-center">
              <div className="max-w-5xl space-y-2 sm:space-y-4">
                <p className="text-sm sm:text-sm text-[#415052] leading-snug sm:leading-relaxed indent-8 sm:indent-20">
                  - Nous sommes aussi bailleurs, et comme beaucoup, on est pas satisfait par les outils compliqués, chers, mal conçus — et surtout chronophages.
                </p>
                <p className="text-sm sm:text-sm text-[#415052] leading-snug sm:leading-relaxed indent-8 sm:indent-20">
                  - Notre souhait  👉 <strong>penser le moins possible</strong> à la gestion locative tout <strong>en gardant le contrôle.</strong>
                </p>
               <p className="text-sm sm:text-sm text-[#415052] leading-snug sm:leading-relaxed indent-8 sm:indent-20">
                  - Notre idée  👉 un outil <strong>ultra simple, ultra fluide </strong>. <span className="italic">"Je ne fais quasiment rien, je ne rate rien... et je garde la main."</span>
                </p>
             
              </div>
            </div>

            <h3 className="text-xl sm:text-2xl font-bold text-[#1a1f20] mb-8 text-center mt-8">
              Tout ce que fait l'automatisation pour vous :
            </h3>
              ...
              <div className="flex-1 text-left">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-[#1a1f20] mb-1 text-sm">Vos quittances, envoyées automatiquement chaque mois</h4>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#415052] leading-relaxed">
                        Toutes vos quittances restent accessibles, à tout moment, au même endroit.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-[#1a1f20] mb-1 text-sm">Votre bilan annuel, automatique et précieux pour votre déclaration</h4>
                      <p className="text-xs text-[#415052] leading-relaxed">
                        Loyers et charges sont cumulés automatiquement sur l'année,<br />
                        Un gain de temps précieux pour votre déclaration.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#415052] leading-relaxed">
                        Le calcul se fait quand vous voulez en quelques secondes,<br />
                        On vous envoie un rappel automatique programmé = zéro oublis = zero perte.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-[#1a1f20] mb-1 text-sm">La lettre de révision, automatique déjà prête</h4>
                      <p className="text-xs text-[#415052] leading-relaxed">
                        La lettre est faite, pré-remplie, conforme, il ne reste plus qu'à l'envoyer au locataire.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#415052] leading-relaxed">
                        Un message déjà rédigé, modifiable en un clic,<br />
            ...
            <div className="bg-[#7CAA89]/10 border-l-0 border-[#7CAA89] rounded-xl p-4 mt-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <p className="text-base sm:text-lg font-bold text-[#1a1f20]">
                  Un plan premium avec 6 fonctionnalités d'automatisation pour 6 X moins chers...
                </p>
                <button
