    ...
    <div className="min-h-screen bg-amber-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Vos quittances,<br />
                <span className="text-orange-600">sans galère</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="bg-orange-600 text-white px-8 py-4 rounded-2xl font-bold shadow-lg hover:bg-orange-700 transition-all transform hover:scale-105"
                >
      ...
      <section className="py-12 bg-white border-y border-orange-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              <Heart className="w-12 h-12 text-orange-600 mx-auto mb-4 fill-current" />
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border-2 border-green-200">
                ...
                <div className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        placeholder="Ex: 800"
                        className="w-full px-4 py-4 rounded-xl border-2 border-green-200 focus:border-green-500 focus:outline-none text-lg"
                      />
                    </div>
                    <div>
                  ...
                  {!formData.isProrata && (
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full px-4 py-4 rounded-xl border-2 border-green-200 focus:border-green-500 focus:outline-none text-lg bg-white"
                      >
                  ...
                  <div className="bg-white rounded-xl p-4 border-2 border-green-300">
                    <label className="flex items-start cursor-pointer">
                      <input
                        ...
                        className="w-6 h-6 mt-1 text-green-600 border-2 border-gray-300 rounded"
                      />
                      <div className="ml-3">
                  ...
                  {formData.isProrata && prorataAmounts.total > 0 && (
                    <div className="bg-white rounded-xl p-6 border-2 border-green-500 text-center">
                      <p className="text-gray-600 mb-2">Montant calculé :</p>
                      <p className="text-4xl font-bold text-green-600">{prorataAmounts.total.toFixed(2)}€</p>
                    </div>
                  )}
                </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-red-600">
        <div className="max-w-4xl mx-auto px-6 text-center text-white">
          ...
          <Link
            to="/automation"
            className="inline-flex items-center bg-white text-orange-600 px-10 py-5 rounded-2xl font-bold text-xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105"
          >
