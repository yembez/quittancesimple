...
const AutomationPlusSetup = () => {
  ...
  // 1,50€ pour le 1er locataire, +1€ par locataire supplémentaire
  const basePrice = 1.50;
  const additionalTenantPrice = 1.00;
  const totalPrice = locataires.length === 1
    ? basePrice
    : basePrice + ((locataires.length - 1) * additionalTenantPrice);
  ...
  useEffect(() => {
    ...
    const loadProprietaireData = async () => {
      try {
        ...
        if (propData && propData.plan_actuel === 'Quittance Automatique+') {
          // Propriétaire existant avec plan Automatique+ → Mode "ajout de locataire"
          setProprietaire({
            nom: propData.nom || '',
          ...
          console.log(`Vous avez actuellement ${nombreLocatairesActuels} locataire(s). Ajout d'un nouveau locataire: +1€/mois`);
        }
    ...
    try {
      ...
      const { error: updateError } = await supabase
        ...
        .update({
          ...
          plan_actuel: 'Quittance Automatique+',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#fefdf9] via-white to-[#79ae91]/5 py-12">
      <div className="max-w-4xl mx-auto px-6">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="w-16 h-16 bg-gradient-to-br from-[#79ae91] to-[#6a9d7f] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
            <Zap className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-4xl font-bold text-[#415052] mb-4">
            {isAddMode ? 'Ajouter un nouveau locataire' : 'Configuration Quittance Automatique+'}
          </h1>
        ...
        {!isAddMode && (
          ...
          <div className="flex items-center justify-center space-x-4">
            <div className={`flex items-center ${step === 'intro' ? 'text-[#79ae91]' : step !== 'intro' ? 'text-[#79ae91]' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${step === 'intro' ? 'bg-[#79ae91] text-white' : step !== 'intro' ? 'bg-[#79ae91] text-white' : 'bg-gray-200'}`}>
                {step !== 'intro' ? <CheckCircle className="w-5 h-5" /> : '1'}
              </div>
              <span className="ml-2 font-medium hidden sm:inline">Introduction</span>
            </div>
            <div className="w-12 h-0.5 bg-gray-300"></div>
            <div className={`flex items-center ${step === 'proprietaire' ? 'text-[#79ae91]' : step === 'locataires' || step === 'summary' ? 'text-[#79ae91]' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${step === 'proprietaire' ? 'bg-[#79ae91] text-white' : (step === 'locataires' || step === 'summary') ? 'bg-[#79ae91] text-white' : 'bg-gray-200'}`}>
            ...
            <div className="w-12 h-0.5 bg-gray-300"></div>
            <div className={`flex items-center ${step === 'locataires' ? 'text-[#79ae91]' : step === 'summary' ? 'text-[#79ae91]' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${step === 'locataires' ? 'bg-[#79ae91] text-white' : step === 'summary' ? 'bg-[#79ae91] text-white' : 'bg-gray-200'}`}>
                {step === 'summary' ? <CheckCircle className="w-5 h-5" /> : '3'}
              </div>
              <span className="ml-2 font-medium hidden sm:inline">Locataires</span>
            </div>
            <div className="w-12 h-0.5 bg-gray-300"></div>
            <div className={`flex items-center ${step === 'summary' ? 'text-[#79ae91]' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${step === 'summary' ? 'bg-[#79ae91] text-white' : 'bg-gray-200'}`}>
                4
              </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          ...
          {step === 'intro' && (
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-[#79ae91]/10 to-[#6a9d7f]/10 rounded-2xl p-6 border border-[#79ae91]/20">
                <h3 className="text-xl font-bold text-[#415052] mb-4 flex items-center">
                  <Sparkles className="w-6 h-6 mr-2 text-[#79ae91]" />
                  Comment fonctionne Quittance Automatique+ ?
                </h3>
              ...
              <div className="space-y-4">
                <h4 className="font-bold text-[#415052] text-lg">Les étapes :</h4>

                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 rounded-full bg-[#79ae91]/20 flex items-center justify-center flex-shrink-0">
                    <span className="font-bold text-[#79ae91]">1</span>
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 rounded-full bg-[#79ae91]/20 flex items-center justify-center flex-shrink-0">
                    <span className="font-bold text-[#79ae91]">2</span>
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 rounded-full bg-[#79ae91]/20 flex items-center justify-center flex-shrink-0">
                    <span className="font-bold text-[#79ae91]">3</span>
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 rounded-full bg-[#79ae91]/20 flex items-center justify-center flex-shrink-0">
                    <span className="font-bold text-[#79ae91]">4</span>
                  </div>
                  <div>
              ...
              <button
                ...
                className="w-full py-4 rounded-full bg-gradient-to-r from-[#79ae91] to-[#6a9d7f] hover:from-[#6a9d7f] hover:to-[#769272] text-white font-bold transition-all shadow-lg hover:shadow-xl flex items-center justify-center"
              >
          ...
          {step === 'proprietaire' && (
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-[#415052] mb-6 flex items-center">
                <User className="w-7 h-7 mr-3 text-[#79ae91]" />
                Vos informations
              </h2>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 rounded-lg border border-gray-300 focus:border-[#79ae91] focus:ring-2 focus:ring-[#79ae91]/20 transition-all bg-gray-50"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full pl-11 pr-4 py-3 rounded-lg border border-gray-300 focus:border-[#79ae91] focus:ring-2 focus:ring-[#79ae91]/20 transition-all min-h-[80px]"
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-full bg-gradient-to-r from-[#79ae91] to-[#6a9d7f] text-white font-bold transition-all shadow-lg hover:shadow-xl flex items-center justify-center"
                >
          ...
          {step === 'locataires' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-[#415052] flex items-center">
                  <Users className="w-7 h-7 mr-3 text-[#79ae91]" />
                  {isAddMode ? 'Ajouter un nouveau locataire' : 'Vos locataires'}
                </h2>
                <div className="bg-gradient-to-r from-[#79ae91] to-[#6a9d7f] text-white px-4 py-2 rounded-full font-bold text-sm shadow-lg">
                  {isAddMode
                  ...
                  <div className="text-sm text-blue-800">
                    {isAddMode ? (
                      <>
                        ...
                        <p>Tarification : +1€/mois par nouveau locataire ajouté</p>
                        <p className="font-semibold mt-2">Nouveau total après ajout : {(basePrice + (nombreLocatairesExistants + locataires.length - 1) * additionalTenantPrice).toFixed(2)}€/mois</p>
                      </>
                    ) : (
                      <>
                        <p className="font-semibold mb-1">Tarification : 1,50€ pour le 1er locataire, puis +1€ par locataire supplémentaire</p>
                ...
                {locataires.map((locataire, index) => (
                  <div key={index} className="border-2 border-gray-200 rounded-2xl p-6 relative">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="font-bold text-[#415052]">Locataire {index + 1}</h3>
                      {locataires.length > 1 && (
                        <button
              ...
              <button
                ...
                className="w-full py-3 rounded-xl border-2 border-dashed border-[#79ae91] text-[#79ae91] font-semibold hover:bg-[#79ae91]/5 transition-all flex items-center justify-center"
              >
                <Plus className="w-5 h-5 mr-2" />
                Ajouter un locataire (+1€/mois)
              </button>
          ...
          {step === 'summary' && (
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-[#415052] mb-6 flex items-center">
                <CheckCircle className="w-7 h-7 mr-3 text-[#79ae91]" />
                Récapitulatif
              </h2>

              <div className="bg-gradient-to-r from-[#79ae91]/10 to-[#6a9d7f]/10 rounded-2xl p-6 border border-[#79ae91]/20">
                <h3 className="font-bold text-[#415052] mb-3">Propriétaire</h3>
              ...
              <div className="bg-white rounded-2xl border-2 border-gray-200 p-6">
                <h3 className="font-bold text-[#415052] mb-4">
                  ...
                  {locataires.map((loc, index) => (
                    <div key={index} className="flex justify-between items-start pb-4 border-b border-gray-200 last:border-0 last:pb-0">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-[#415052]">{parseFloat(loc.loyer_mensuel) + parseFloat(loc.charges_mensuelles)}€</p>
              ...
              <div className="bg-gradient-to-r from-[#79ae91] to-[#6a9d7f] rounded-2xl p-6 text-white">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex-1 py-4 rounded-full bg-gradient-to-r from-[#79ae91] to-[#6a9d7f] hover:from-[#6a9d7f] hover:to-[#769272] text-white font-bold transition-all shadow-lg hover:shadow-xl flex items-center justify-center disabled:opacity-50"
                >
                  {loading ? (
                    <>
