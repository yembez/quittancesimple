  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section id="generator" className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <div className="inline-flex items-center bg-green-50 text-green-700 px-3 py-1.5 rounded-full text-sm font-medium mb-4">
              <CheckCircle2 className="w-4 h-4 mr-2" />
                  ...
                  {formData.isProrata && prorataAmounts.total > 0 && (
                    <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium text-green-800">Total calculé :</span>
                        <span className="text-2xl font-bold text-green-900">{prorataAmounts.total.toFixed(2)}€</span>
                      </div>
                    </div>
                  )}
                </div>
