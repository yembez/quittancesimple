  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      {proprietaire && !proprietaire.abonnement_actif && (
        <div className="bg-[#7CAA89]/10 border-b border-[#7CAA89]/20">
          <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <h2 className="text-xl font-bold text-[#2D5C3F] mb-1">
              Bienvenue dans {proprietaire.plan_actuel || 'Quittance Automatique'} !
            </h2>
            <p className="text-gray-700">
              Complétez vos informations et ajoutez vos locataires. Le paiement se fera une fois vos locataires configurés.
            </p>
          </div>
        </div>
      )}
