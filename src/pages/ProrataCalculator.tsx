        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center space-x-4 mb-8">
              <div className="w-14 h-14 bg-[#2D3436] rounded-2xl flex items-center justify-center shadow-lg">
                <Calculator className="w-7 h-7 text-white" />
              </div>
              <h2 className="text-2xl font-bold text-[#1a1f20]">Vos informations</h2>
            </div>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-[#2D3436] focus:outline-none transition-colors"
                    placeholder="800.00"
                    step="0.01"
                  />
                </div>
          ...
          >
            <div className="flex items-center space-x-4 mb-8">
              ...
              <h3 className="text-2xl font-bold text-[#1a1f20]">Résultat du calcul</h3>
            </div>

            <div className="space-y-6">
              {result.montantProrata > 0 ? (
                <>
                  <div className="bg-gradient-to-br from-[#2D3436] to-[#6b9d82] rounded-2xl p-8 text-center shadow-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-xl p-5 border-2 border-gray-200">
                      ...
                      <div className="text-2xl font-bold text-[#1a1f20]">{result.loyerProrata.toFixed(2)}€</div>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-5 border-2 border-gray-200">
                      <div className="text-xs font-medium text-gray-500 mb-2">Charges prorata</div>
                      <div className="text-2xl font-bold text-[#1a1f20]">{result.chargesProrata.toFixed(2)}€</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-5 border-2 border-gray-200">
                    ...
                    <div className="flex items-center justify-center space-x-4">
                      <div className="text-center">
                        <div className="text-3xl font-bold text-[#1a1f20]">{result.joursOccupes}</div>
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-[#2D3436]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Calculator className="w-8 h-8 text-[#2D3436]" />
                </div>
                <h3 className="font-bold text-[#1a1f20] mb-2 text-lg">Calcul automatique</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-[#1a1f20] mb-2 text-lg">100% conforme</h3>
                <p className="text-[#415052]/70 leading-relaxed">
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-[#1a1f20] mb-2 text-lg">Toujours gratuit</h3>
                <p className="text-[#415052]/70 leading-relaxed">
