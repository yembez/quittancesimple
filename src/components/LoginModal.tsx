...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, mode = 'login', onModeChange, selectedPlan = 'auto' }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signup') {
        ...
        const planName = selectedPlan === 'plus' ? 'Quittance Connectée+' : 'Quittance Automatique';
