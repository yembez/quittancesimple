                          ...
                          isSubscriptionActive ? (
                            ...
                            <div className="group relative">
                              ...
                              <div className="absolute bottom-full left-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-normal pointer-events-none z-50 w-64">
                                Souscrivez à Quittance Automatique pour programmer vos rappels automatiques !
                              </div>
                            </div>
                          )
                        )}
                        ...
                        {isSubscriptionActive ? (
                          ...
                          <div className="group relative w-[140px]">
                            ...
                            <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-normal pointer-events-none z-50 w-64">
                              Souscrivez à Quittance Automatique pour envoyer automatiquement vos quittances !
                            </div>
                          </div>
                        )}
                        {isSubscriptionActive ? (
                          ...
                          <div className="group relative w-[140px]">
                            ...
                            <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-normal pointer-events-none z-50 w-64">
                              Souscrivez à Quittance Automatique pour envoyer automatiquement vos relances !
                            </div>
                          </div>
                        )}
                      </>
        ...
        <div className="mt-6 bg-gray-50 rounded-xl p-4 sm:p-6 border border-gray-200">
          <div className="mb-4">
            <p className="text-sm text-gray-600 mb-3 text-center">
              Automatisez vos quittances avec l'offre de lancement pour <span className="font-bold text-[#7CAA89]">{locataires.length} {locataires.length === 1 ? 'locataire' : 'locataires'}</span>
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-3 max-w-2xl mx-auto">
              ...
              >
                ...
                <div className="mb-2">
                  <div className="flex items-baseline gap-1">
                    <span className="text-2xl font-bold text-gray-900">
                      {locataires.length <= 2 ? '9.90' : locataires.length <= 5 ? '14.90' : '24.90'} €
                    </span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-end gap-4 pt-4 border-t border-gray-200">
            <div className="text-center sm:text-right">
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">
                {calculateTotal().toFixed(2)} €<span className="text-base font-normal text-gray-600">/{billingCycle === 'yearly' ? 'an' : 'mois'}</span>
              </p>
            </div>
            <button
