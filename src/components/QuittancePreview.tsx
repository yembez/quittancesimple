    ...
    <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 relative">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="text-sm space-y-1">
              <p className="font-semibold">{normalizedData.baillorName || '[Nom du bailleur]'}</p>
              <p>{normalizedData.baillorAddress || '[Adresse du bailleur]'}</p>
              <p>{normalizedData.baillorEmail || '[Email du bailleur]'}</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="text-sm space-y-1">
              <p className="font-semibold">{normalizedData.locataireName || '[Nom du locataire]'}</p>
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-sm">{normalizedData.logementAddress || '[Adresse du logement loué]'}</p>
        </div>
        ...
        <div className="bg-white border-2 border-gray-300 p-6 rounded-lg">
          <p className="text-sm leading-relaxed text-gray-800">
            ...
            <strong>{normalizedData.locataireName || '[Nom du locataire]'}</strong>, la somme de{' '}
