        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-base text-gray-300">4.9/5 · 2 500+ propriétaires</span>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-base text-gray-300">contact@quittancesimple.fr</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center">
                  <MapPin className="w-4 h-4 text-gray-300" />
                </div>
                <span className="text-base text-gray-300">Paris, France</span>
              </div>
            </div>
          </div>

          <div>
            <h3 className="text-base font-bold mb-4 text-white uppercase tracking-wide">Produit</h3>
          ...
          <div>
            <h3 className="text-base font-bold mb-4 text-white uppercase tracking-wide">Ressources</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="text-base font-bold mb-4 text-white uppercase tracking-wide">Entreprise</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="text-base font-bold mb-4 text-white uppercase tracking-wide">Légal</h3>
            <ul className="space-y-3">
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center space-x-2 text-gray-400 text-sm">
              ...
              >
                <Heart className="w-4 h-4 fill-current" style={{
