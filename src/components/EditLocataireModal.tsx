    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-2xl w-full shadow-2xl">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-sm text-blue-800">
              <strong>Total mensuel:</strong> {(formData.loyer_mensuel + formData.charges_mensuelles).toFixed(2)} €
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 bg-gray-50 px-6 py-4 flex justify-end space-x-3 rounded-b-2xl">
          ...
          <button
            onClick={handleSave}
            disabled={saving || !formData.nom || !formData.adresse_logement || formData.loyer_mensuel < 0 || formData.charges_mensuelles < 0}
