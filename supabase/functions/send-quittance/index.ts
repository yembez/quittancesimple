...
<head>
  ...
  <style>
    ...
    .header {
      background: linear-gradient(135deg, #5a7476 0%, #7ba0a3 100%);
      color: white;
      padding: 30px 20px;
      text-align: center;
    }
    ...
    .cta-button:hover {
      background: linear-gradient(135deg, #c49f30 0%, #e4b420 100%);
    }
    .time-saved {
...
<body>
  <div class="container">
    <div class="header">
      <h1>📄 Votre quittance de loyer</h1>
    </div>
    ...
    <div class="content">
      ...
      <div class="section">
        <p>Votre quittance de loyer pour <strong>${data.periode}</strong> est prête.</p>
        <p>Vous la trouverez en pièce jointe au format PDF, prête à être envoyée à votre locataire.</p>
      </div>

      <div class="highlight-box">
        <h3>💡 À savoir</h3>
        <p>Cette quittance devra être générée chaque mois, ou vous pouvez <strong>ne plus jamais y penser</strong> en utilisant notre outil <strong>Quittance Automatique</strong> :</p>

        <div class="benefits">
          <div class="benefit-item">
            <span class="benefit-icon">✓</span>
            <span>La quittance est <strong>générée automatiquement</strong> tous les mois.</span>
          </div>
          <div class="benefit-item">
            <span class="benefit-icon">✓</span>
            <span>Elle est <strong>envoyée au locataire en 1 seul clic</strong>.</span>
          </div>
        </div>

        <div class="time-saved">
          ⏱️ Temps passé par mois et par quittance : ~5 secondes<br>
          <small>(Un rappel, 1 clic… et c'est tout.)</small>
        </div>
      </div>

      <div class="why-section">
        <h3>�� Pourquoi Quittance Simple ?</h3>
        <p>Parce que nous sommes bailleurs nous aussi.<br>
        Et nous avons créé l'outil que nous aurions voulu avoir depuis longtemps :</p>
        <ul>
          <li><strong>Simple</strong></li>
          <li><strong>Sans usine à gaz</strong></li>
          <li><strong>Sans paramétrage inutile</strong></li>
          <li><strong>Jusqu'à 6 fois moins cher</strong> que les outils complexes du marché</li>
        </ul>
        <p style="margin-top: 15px;">Pourquoi ? Parce qu'on est simple justement !</p>
      </div>

      <div style="text-align: center; margin: 30px 0;">
        <p style="font-size: 16px; margin-bottom: 15px;"><strong>👉 Profitez de l'offre de lancement en cours</strong></p>
        <p>Activez l'automatisation dès maintenant et, sans engagement.</p>
        <a href="https://quittancesimple.fr/automation" class="cta-button">
          Activer l'envoi automatique des quittances →
        </a>
        <p style="font-size: 14px; color: #6c757d; margin-top: 15px;">
          Bien entendu, le générateur gratuit reste accessible à tout moment.
        </p>
      </div>

      <div class="signature">
        <p>À très vite,<br>
        <strong>L'équipe Quittance Simple</strong></p>
      </div>

      <div class="ps">
        <strong>PS :</strong> La plupart de nos utilisateurs passent à l'automatisation après leur 2ᵉ quittance… quand ils réalisent qu'ils n'ont plus besoin d'y penser.
      </div>
    </div>

    <div class="footer">
      <p>Cet email a été envoyé par <strong>Quittance Simple</strong></p>
    ...
    if (data.locataireId) {
      ...
      try {
        ...
        if (!locataireError && locataireData) {
          // Calculer les dates de la période à partir de data.periode
          const currentDate = new Date();
          let year = currentDate.getFullYear();
          let month = currentDate.getMonth();

          // Essayer d'extraire le mois et l'année depuis data.periode si disponible
          if (data.periode) {
