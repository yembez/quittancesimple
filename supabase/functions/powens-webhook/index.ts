// ============================================================================
// Powens → Supabase Webhook Receiver
// Reçoit : ACCOUNT_SYNCED, CONNECTION_SYNCED, TRANSACTIONS_CLUSTERED
// Insert : bank_transactions
// Log     : powens_callback_logs
// ============================================================================
...
// ==============================================
// Supabase Client (SERVICE KEY = full access)
// ==============================================
...
// Insert a single transaction into DB
...
// Process events containing accounts + transactions
async function processEvent(body: any) {
  ...
  // Find local connection in bank_connections
